...
class ClienteConsultasDaoJDBC(DaoJDBCBase):
    ...
    def listar_clientes_completo(self):
        return self.consultar(self.SQL_LISTAR_CLIENTES_COMPLETO)
 
    def buscar_clientes(self, texto: str):
        t = f"%{texto.lower().strip()}%"
        return self.consultar(self.SQL_BUSCAR_CLIENTES, (t, t, t))
 
    def buscar_clientes_estado(self, estado: str):
        return self.consultar(self.SQL_BUSCAR_CLIENTES_ESTADO, (estado.lower(),))
