...
class ClaseConsultasDaoJDBC(DaoJDBCBase):
    ...
    SQL_BUSCAR_CLASE = ("SELECT id_clase, nombre_actividad, dia_semana, hora_inicio, hora_fin, aforo_maximo, nivel_intensidad, calorias_estimadas"
                        "FROM clase"
    ...
    def buscar_clases(self, texto: str):
        ...
        return self.consultar(self.SQL_BUSCAR_CLASE, (t,))

    def ocupacion_clases(self):
        return self.consultar(self.SQL_OCUPACION_CLASE)

    def clases_entrenador_tabla(self, id_entrenador):
        return self.consultar(self.SQL_CLASES_ENTRENADOR_TABLA, (id_entrenador,))

    def ocupacion_clases_entrenador(self, id_entrenador):
        return self.consultar(self.SQL_OCUPACION, (id_entrenador,))
    ...
    def recepcion_clases_hoy(self):
        datos = self.consultar(self.QL_RECEPCION_CLASES_HOY)
